	    ...
	    <div class="page-title">
	        <div class="row">
	            <div class="col-12 col-md-6 order-md-1 order-first">
	                ...
	                <p class="text-subtitle text-muted">Manage (suspend/activate, email, delete subscribers) all subscribers from the website on this page.</p>
	            </div>
	            <div class="col-12 col-md-6 order-md-2 order-last">
	            	<div class="float-start float-lg-end"> 
	            		...
	            		<a class="btn btn-md btn-primary mr-1 mb-1" href="<?php echo ADMIN_BASE_PATH.'views/subscriptions/email_drafts'; ?>" ><span class="bi bi-list bi-center"> </span> Email Drafts </a>
	            		<?php endif ?>
	            		<?php if ($neo_con_permission == 1): ?>
	            		<a class="btn btn-md btn-primary mr-1 mb-1" href="<?php echo ADMIN_BASE_PATH.'views/contacts/'; ?>" ><span class="bi bi-person-badge bi-center"> </span> Contacts </a>
	            		<?php endif ?>
                ...
                <div class="card">
                	<div class="card-body">
                		...
                		<div id="subscription_data">
                			<!-- classes/subscriptions_cl/FetchSubscriptions.php -->
                		</div>
                	</div>
                </div>
	        </div>

<?php
    ...
    $page_title = 'News: Sports, Entertainment, Shows, Culture, Fashion, etc.';
    $news_active = 'active';
    $news_cul_active = 'active';
    ...
    <section class="cat_news_grid_section">
        <div class="row">
            <div class="container bg_light cat_title_container no_paddding_x">
                <div class="col-lg-12 page_heading"><h2>Culture</h2></div>
            </div>
        </div>
            ...
            <div class="container bg_light cat_news_grid_container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 boder_all_grey">
                        <div class="show_exhausted"><span class="bg-secondary px-4 py-3 d-block w-100"><strong>Nothing to show under culture. Explore other news categories.</strong></span></div>
                    </div>
                    <?php } ?>
                </div>
                ...
                <div class="row" id="culture_news_data">

<?php
    ...
    $page_title = 'News: Fashion & Lifestyle';
    $news_active = 'active';
    $news_fas_active = 'active';
    ...
    $src_news_category = 'fashion & lifestyle';
    $page_name         = 'fashion & lifestyle';
?>
    ...
    <section class="cat_news_grid_section">
        <div class="row">
            <div class="container bg_light cat_title_container no_paddding_x">
                <div class="col-lg-12 page_heading"><h2>Fashion & Lifestyle</h2></div>
            </div>
        </div>
            ...
            <div class="container bg_light cat_news_grid_container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 boder_all_grey">
                        <div class="show_exhausted"><span class="bg-secondary px-4 py-3 d-block w-100"><strong>Nothing to show under fashion and lifestyle category. Explore other news categories.</strong></span></div>
                    </div>
                    <?php } ?>
                </div>
                ...
                <div class="row" id="fashion_news_data">
...
<script>
    ...
    $(document).ready(function() {
        var category = 'fashion & lifestyle';

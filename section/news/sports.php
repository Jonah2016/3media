<?php
    ...
    $page_title = 'News: Sports';
    $news_active = 'active';
    $news_spt_active = 'active';
    ...
    <section class="cat_news_grid_section">
        <div class="row">
            <div class="container bg_light cat_title_container no_paddding_x">
                <div class="col-lg-12 page_heading"><h2>Sports</h2></div>
            </div>
        </div>
            ...
            <div class="container bg_light cat_news_grid_container">
                ...
                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="card-block py-5 px-4">
                                            <h6 class="post_category py-2"><?php echo $n1_author; ?> | <?php echo $n1_date; ?></h6>
                    ...
                    <div class="col-12 boder_all_grey">
                        <div class="show_exhausted"><span class="bg-secondary px-4 py-3 d-block w-100"><strong>Nothing to show under sports category. Explore other news categories.</strong></span></div>
                    </div>
                    <?php } ?>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="vid_thumb_container_md">
                                            <a href="<?php echo $new_video_page_url1; ?>" class="video_play_button"><i class="bi bi-play-circle"></i></a>
                                    ...
                                    <div class="col-12">
                                        <div class="card-block py-2 px-4">
                                            ...
                                            <p class="post_title pb-3"><a href="<?php echo $new_video_page_url1; ?>"><?php echo $v1_title; ?></a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row" id="sports_news_data">

<?php
    ...
    $page_name = 'payment-success-page';
...
<div class="page_content">
   <div class="bg_light payment_success_box d-flex justify-content-center align-items-center">
        <div class="container-lg">
            <div class="row">
                <div class="col-lg-10 col-md-10 col-sm-12 offset-lg-1 offset-sm-0">
                    <div class="row" id="precessMsgContainer">
                        <div class="jumbotron clean_shadow mt-0 py-4 boder_all_dark py-5 noselect">
                            <h2 class="text-center payment_success_title">Payment Successful!</h2>
                            <h3 class="text-center pt-2" id="paySuccessMsg">Thank you for your payment, you'll receive an email shortly.</h3>
                            <div class="text-center py-2 payment_success_icon" id="paySuccessIcon"><i class="bi bi-check-circle text-success"></i></div>
                            <center class="mb-2">
                                <a href="<?php echo SECTION_PATH.'events/'; ?>" class="btn btn-lg btn-dark p-2">Check out more events</a>
                                <a href="<?php echo SECTION_PATH.'snap_shots/'; ?>" class="btn btn-lg btn-secondary p-2">Catch some snapshots</a>
                            </center>
                        </div>
                    </div>
                </div>                
